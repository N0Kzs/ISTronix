        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div class="container mt-4">
                    <div>
                        <h4 class="mb-4 text-white bg-primary p-2 rounded">All Categories</h4>
                    </div>
                        ...
                        <table id="myTable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                if (!mysqli_num_rows($query) > 0) {
                                    echo '<tr><td colspan="5" class="text-center">No Available Products</td></tr>';
                                } else {
                                    while ($rows = mysqli_fetch_array($query)) {
                                        echo "<tr>
                                                ...
                                                <td><img src='../assets/images/Categories/". $rows['c_img']."' width='200' title='".$rows['c_img']."'></td>
                                                <td>
                                                    <a style='margin-bottom: 10px; 'href='update_cat.php?cat_upd=".$rows['c_id']."' class='btn btn-outline-primary'>Edit</a>
                                                    <a href='del_cat.php?cat_del=".$rows['c_id']."' class='btn btn-outline-danger'>Delete</a>
                                                </td>
                                            </tr>";
                                    }
                                }
