...
if(isset($_POST["submit"])){
    ...
    if($_FILES["image"]["error"] == 4){
        ...
        if (!in_array($imageExtension, $validImageExtension)) {
            ...
            $query = "INSERT INTO categories VALUES('', '$name', '$des', '$date', '$newImageName')";
        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div class="container mt-4">
                    <div>
                        <h4 class="mb-4 text-white bg-primary p-2 rounded">Add Categories</h4>
                    </div>
                    <div class="table-responsive">
                        <form action="add_categories.php" method="POST" class="p-4 border rounded bg-light" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="cDes" id="cDes" rows="4" class="form-control" required></textarea>
                            </div> <br>
